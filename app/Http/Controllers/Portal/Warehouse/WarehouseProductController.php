...
{
    public function store(WarehouseProductService $warehouseProductService, WarehouseProductDto $request, Warehouse $warehouse)
    {
        return $this->ok($warehouseProductService->createWarehouseProduct($request, $warehouse));
    }
